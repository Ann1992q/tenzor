...
#ЦЕЛИ:
# 1. Скачать плагин для WINDOWS, веб-установщикв папку с данным тестом
# 2. Убедиться, что плагин скачался
#3. Сравгить размер скачанного файла в мегабайтах с тем, что на сайте
